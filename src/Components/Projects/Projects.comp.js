...
function Projects() {
  ...
  return (
    <div className="mt-[50%] pt-[5%]" id="projects">
      <div className="section">
        <h1 className="section-heading">My Projects</h1>
        <div className="mt-10 space-y-5">
          <div className="mt-5 mx-auto w-[90%] space-y-8">
            <ProjectsCard
              projectName="Twitter Clone (In progress)"
              description="This reddit clone is a MERN project with the backend fully complete but the frontend is incomplete."
              path="https://github.com/SajawalHassan/twitter_clone_mern"
            />
            <ProjectsCard
              projectName="Reddit Clone (In progress)"
              description="This reddit clone is a MERN project with the backend fully complete but the frontend is incomplete."
              path="https://github.com/SajawalHassan/reddit_clone_mern"
            />
            <ProjectsCard
